...
var useWebVitals = function useWebVitals(_ref3) {
  ...
  var sendVitals = function sendVitals() {
    ...
    (0, _webVitals.onCLS)(updateWebVitals, {
  ...
  (0, _react.useEffect)(function () {
    try {
      ...
      (0, _webVitals.onFID)(updateWebVitals);
      (0, _webVitals.onLCP)(updateWebVitals, {
        reportAllChanges: true
      });
      (0, _webVitals.onFCP)(updateWebVitals);
      (0, _webVitals.onTTFB)(updateWebVitals);
      (0, _webVitals.onINP)(updateWebVitals);
    } catch (_ref4) {
